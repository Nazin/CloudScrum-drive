...
<div class="modal fade" id="new-project-modal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <form role="form" class="form-horizontal" name="newProjectForm" novalidate>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" ng-disabled="newProjectForm.$invalid" ng-click="createProject()">Save</button>
                </div>
            </form>
        </div>
    </div>
